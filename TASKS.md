...
*   [ ] **User & Group Management**
    *   [ ] Create interface to input new username and password.
    *   [ ] Implement logic to add users and add them to `sudo` group.
    *   [ ] Implement SSH key addition for the new user.
*   [ ] **SSH Hardening**
    *   [ ] Create module to modify `/etc/ssh/sshd_config`.
    *   [ ] Add options to disable root login.
    *   [ ] Add options to disable password authentication (keys only).
*   [ ] **Firewall Setup**
    *   [ ] Implement UFW (Uncomplicated Firewall) installation and enablement.
    *   [ ] Create default ruleset (Allow SSH, Deny Incoming, Allow Outgoing).
    *   [ ] Add options to open specific ports (80, 443).
*   [ ] **Service Installation**
    *   [ ] Create a selection menu for common services (Nginx, Apache, MySQL/MariaDB, Docker).
    *   [ ] Implement installation scripts for each service.
